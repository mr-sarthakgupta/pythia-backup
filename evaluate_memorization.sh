...
# python batch_eval.py --model-config configs/models.json --quant-config configs/baseline-config.json --num-samples 10000 --batch-size 128
...
for swap in "${swap_values[@]}"; do
    ...
    python batch_eval.py --model-config configs/models.json \
